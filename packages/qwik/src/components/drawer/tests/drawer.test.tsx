...
describe('Drawer', () => {
  ...
  it('renders open with dialog semantics when open', async () => {
    ...
    expect(document.querySelector('[data-testid="backdrop"]')).toBeTruthy()
    expect(document.querySelector('[data-testid="positioner"]')).toBeTruthy()
    expect(document.querySelector('[data-part="grabber"]')).toBeTruthy()
    expect(document.querySelector('[data-part="grabber-indicator"]')).toBeTruthy()
  })
  ...
  it('does not render content with lazyMount until opened', async () => {
    ...
    expect(document.querySelector('[data-testid="backdrop"]')).toBeFalsy()
  })
