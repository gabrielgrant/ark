...
export { MenuArrow as Arrow, type MenuArrowBaseProps as ArrowBaseProps, type MenuArrowProps as ArrowProps } from './menu-arrow.tsx'
export {
...
export { MenuItem as Item, type MenuItemBaseProps as ItemBaseProps, type MenuItemProps as ItemProps } from './menu-item.tsx'
export {
...
export { MenuRoot as Root, type MenuRootBaseProps as RootBaseProps, type MenuRootProps as RootProps } from './menu-root.tsx'
export {
  MenuSeparator as Separator,
  type MenuSeparatorBaseProps as SeparatorBaseProps,
  type MenuSeparatorProps as SeparatorProps,
} from './menu-separator.tsx'
export { MenuTrigger as Trigger, type MenuTriggerBaseProps as TriggerBaseProps, type MenuTriggerProps as TriggerProps } from './menu-trigger.tsx'
export {
